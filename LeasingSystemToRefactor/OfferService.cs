...
namespace LeasingSystemToRefactor
{
    public class OfferService : IOfferService
    {
        ...
        private decimal GetInterestRate(string ccy, int numberOfMonths, decimal commision)
        {
            return interestRateCalculator.CalculateInterestRate(ccy, commision, numberOfMonths);
        }
    }
}
